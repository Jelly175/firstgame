...
function buildMessage(customerName) {
  ...
  //  `Hi Sir 👋 \n\n` +
    ...
    `नमस्ते सर 👋 \n\n` +
    `क्या आपके लॉन्ड्री स्टोर में भी कस्टमर्स को बार-बार WhatsApp पर कपड़े रेडी होने का अपडेट मैनुअली भेजना पड़ता है? \n\n` +
    `हम इसे 100% ऑटोमैटिक करने में मदद करते हैं जिससे आपका रोज़ का कम से कम 1 घंटा बचेगा। \n\n` +
    `क्या मैं इसके बारे में 2 लाइन में बताऊँ? \n\n` +
    `— Fabric First`;
  );
}
